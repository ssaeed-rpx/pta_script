...
def main(
    ...
    print("{} Positive Predictions in set out of total {}".format(len(df[df.pred==1]),len(df)))
    
    df[['title','abstract_text','claim_text','pred','pp','top_feats']].to_csv(prediction_file, index=False)
